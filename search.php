...
//-- fin mod : quick title edition ---------------------------------------------
			...
			if ( $show_results == 'posts' )
			{
				...
				$poster .= ( $searchset[$i]['user_id'] != ANONYMOUS ) ? do_color_groups( $searchset[$i]['user_id'], $searchset[$i]['username'] ) : ( ( $searchset[$i]['post_username'] != "" ) ? $searchset[$i]['post_username'] : $lang['Guest'] );
			...
			else
			{
				...
				$topic_author .= ( $searchset[$i]['user_id'] != ANONYMOUS ) ? do_color_groups( $searchset[$i]['user_id'], $searchset[$i]['username'] ) : ( ( $searchset[$i]['post_username'] != '' ) ? $searchset[$i]['post_username'] : $lang['Guest'] );
				...
				$last_post_author = ( $searchset[$i]['id2'] == ANONYMOUS ) ? ( ($searchset[$i]['post_username2'] != '' ) ? $searchset[$i]['post_username2'] . ' ' : $lang['Guest'] . ' ' ) : '<a href="' . append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . '='  . $searchset[$i]['id2']) . '">' . do_color_groups( $searchset[$i]['id2'], $searchset[$i]['user2'] ) . '</a>';
