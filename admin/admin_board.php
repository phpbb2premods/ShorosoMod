...
$colorize_groups_yes = ( $new['colorize_groups'] ) ? "checked=\"checked\"" : "";
$colorize_groups_no = ( !$new['colorize_groups'] ) ? "checked=\"checked\"" : "";
...
$template->assign_vars(array(
	...
	"L_RESET" => $lang['Reset'], 
	'L_COLORIZE_GROUPS' => $lang['colorize_groups'],
	'COLORIZE_GROUPS_YES' => $colorize_groups_yes,
	'COLORIZE_GROUPS_NO' => $colorize_groups_no,
//-- mod : today userlist ------------------------------------------------------
//-- add
