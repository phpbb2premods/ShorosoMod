<!-- $Id: rebuild_search_progress.tpl,v 2.2.1.0 2005/09/15 19:32:23 chatasos Exp $ -->
...
<table width="540" cellspacing="1" cellpadding="2" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row3" align="center">
			<table width="100%" align="center" cellspacing="1" cellpadding="1" class="forumline">
				<tr>
					<th colspan="2"><span class="gen">{L_ACTIVE_PARAMETERS}</span></th>
				</tr>
				<tr>
					<td class="row1" nowrap="nowrap"><span class="genmed">{L_STARTING_POST_ID}</span></td>
					<td class="row1" nowrap="nowrap"><span class="genmed">{START_POST}</span></td>
				</tr>
				<tr>
					<td class="row2" nowrap="nowrap"><span class="genmed">{L_POSTS_LAST_CYCLE}</span></td>
					<td class="row2" nowrap="nowrap"><span class="genmed">{POST_LIMIT}</span></td>
				</tr>
				<tr>
					<td class="row1" nowrap="nowrap"><span class="genmed">{L_TIME_LIMIT}</span></td>
					<td class="row1" nowrap="nowrap"><span class="genmed">{TIME_LIMIT}</span></td>
				</tr>
				<tr>
					<td class="row2" nowrap="nowrap"><span class="genmed">{L_BOARD_STATUS}</span></td>
					<td class="row2" nowrap="nowrap"><span class="genmed">{BOARD_STATUS}</span></td>
				</tr>
			</table>
		</td>
	</tr>
