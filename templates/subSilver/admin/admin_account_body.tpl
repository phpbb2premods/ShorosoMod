...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
        ...
        <table border="0" cellpadding="1" cellspacing="1" width="100%">
          <tr>
                ...
                <td align="right"><span class="gensmall"><a href="{admin_account.U_EDIT_USER}" class="gensmall">{L_EDIT_USER}</a> | 
  ...
  <!-- END switch_no_users -->
  <tr> 
        <td colspan="5" align="right" height="28" class="catBottom">{S_HIDDEN_FIELDS}
