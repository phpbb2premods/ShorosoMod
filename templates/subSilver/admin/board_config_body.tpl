...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1">{L_COLORIZE_GROUPS}</td>
		<td class="row2"><input type="radio" name="colorize_groups" value="1" {COLORIZE_GROUPS_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="colorize_groups" value="0" {COLORIZE_GROUPS_NO} /> {L_NO}</td>
	</tr>
	<tr>
