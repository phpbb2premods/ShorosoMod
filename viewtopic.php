...
//
$sql = "SELECT u.username, u.user_id, u.user_posts, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_viewemail, u.user_rank, u.user_sig, u.user_sig_bbcode_uid, u.user_avatar, u.user_avatar_type, u.user_allowavatar, u.user_allowsmile, u.user_level, p.*,  pt.post_text, pt.post_subject, pt.bbcode_uid, t.topic_poster
...
#
$poster = ( $poster_id == ANONYMOUS ) ? $lang['Guest'] : do_color_groups( $postrow[$i]['user_id'], $postrow[$i]['username'] );
#
#-----[ AFTER, ADD ]------------------------------------------
#
...
//
$pagination = ( $highlight != '' ) ? generate_full_pagination("viewtopic.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;postdays=$post_days&amp;postorder=$post_order&amp;highlight=$highlight", $total_replies, $board_config['posts_per_page'], $start) : generate_full_pagination("viewtopic.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;postdays=$post_days&amp;postorder=$post_order", $total_replies, $board_config['posts_per_page'], $start);
...
$template->assign_vars(array(
	...
	'I_DOWNLOAD_TOPIC' =>  $images['topic_download'],
	'I_DOWNLOAD_POST' =>  $images['post_download'],
	'FORUM_ID' => $forum_id,
