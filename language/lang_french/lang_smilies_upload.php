...
$lang['SU_Upload_Explain'] = 'Vous pouvez utiliser ceci pour uploader de petites images faisant office de smilie ou émoticone . Une seul image à la fois peut être uploadée , et sa taille ne doit pas être supérieure à %s Kilooctects. Les dimensions maximales sont %s pour la largeur et %s pour la hauteur .';
...
$lang['SU_Name_Explain'] = 'Spécifie un nom pour le fichier uploadé. N\'incluez pas l\'extension du fichier (par exemple , utilisez "apple" au lieu "apple.gif").';
$lang['SU_Upload_Succesful'] = 'Fichier uploadé avec succès !';
$lang['SU_Upload_Failed'] = 'Echec de l\'upload du fichier ! Vérifiez que le répertoire de destination des smilies possède les permissions pour ceci .';
...
$lang['SU_Sorry_None'] = 'Vous n\'avez aucune images de smilies uploadées .';
