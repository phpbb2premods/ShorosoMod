...
$mtnc[] = array('check_search_wordlist',
	...
	'Cette commande demande un certain temps pour s\'accomplirh. Il n\'est pas nécessaire d\'exécuter cette vérification mais la faire peut réduire la taille de la base de données. Continuer ?',
	0);
$mtnc[] = array('--', '', '', '');
