...
if (defined('SHOW_ONLINE'))
{
	...
	while( $row = $db->sql_fetchrow($result) )
	{
		...
		if ( $row['session_logged_in'] )
		{
			...
			{
								$row['username'] = do_color_groups( $row['user_id'], $row['username'] );
...
'U_RANKS' => append_sid('ranks.'.$phpEx),
	...
	'S_TOOLBAR' => $toolbar_mod,
	'S_TOOLBAR_FORUM' => $toolbar_forum_mod,
	'S_TOOLBAR_TOPIC' => $toolbar_topic_mod,
