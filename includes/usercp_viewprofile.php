...
$template->assign_vars(array(
	'USERNAME' => do_color_groups( $profiledata['user_id'], $profiledata['username'] ),
	...
	'L_VIEWING_PROFILE' => sprintf($lang['Viewing_user_profile'], do_color_groups( $profiledata['user_id'], $profiledata['username'] )), 
	'L_ABOUT_USER' => sprintf($lang['About_user'], do_color_groups( $profiledata['user_id'], $profiledata['username'] )), 
	'L_AVATAR' => $lang['Avatar'], 
	'L_POSTER_RANK' => $lang['Poster_rank'], 
	'L_JOINED' => $lang['Joined'], 
	'L_TOTAL_POSTS' => $lang['Total_posts'], 
	'L_SEARCH_USER_POSTS' => sprintf($lang['Search_user_posts'], do_color_groups( $profiledata['user_id'], $profiledata['username'] )), 
