...
{
	$moderators[] = '<a href="' . append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . "=" . $row['user_id']) . '">' . do_color_groups( $row['user_id'], $row['username'] ) . '</a>';
}
...
//-- fin mod : quick title edition ---------------------------------------------
		...
		$topic_author .= ( $topic_rowset[$i]['user_id'] != ANONYMOUS ) ? do_color_groups( $topic_rowset[$i]['user_id'], $topic_rowset[$i]['username'] ) : ( ( $topic_rowset[$i]['post_username'] != '' ) ? $topic_rowset[$i]['post_username'] : $lang['Guest'] );
		...
		$last_post_author = ( $topic_rowset[$i]['id2'] == ANONYMOUS ) ? ( ($topic_rowset[$i]['post_username2'] != '' ) ? $topic_rowset[$i]['post_username2'] . ' ' : $lang['Guest'] . ' ' ) : '<a href="' . append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . '='  . $topic_rowset[$i]['id2']) . '">' . do_color_groups( $topic_rowset[$i]['id2'], $topic_rowset[$i]['user2'] ) . '</a>';
		...
		$split_type = '';
		if( ($annonce==1) || ($sticky==1) || ($sujet==1) )
		{
			if( ($topic_rowset[$i]['topic_type']==POST_ANNOUNCE) && ($annonce==1) )
			{
